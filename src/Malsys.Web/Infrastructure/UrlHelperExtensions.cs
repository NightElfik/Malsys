...
namespace Malsys.Web.Infrastructure {
	public static class UrlHelperExtensions {
		...
		//public static HtmlString InputPermaLink(this UrlHelper url, string urlId) {
		//    return new HtmlString("<a href=\"{0}\" \">{0}</a>".Fmt(url.ActionAbsolute(MVC.Permalink.Index(urlId))));
		//}
