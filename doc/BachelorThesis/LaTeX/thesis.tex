...
\usepackage{tikz}
\usetikzlibrary{positioning,shapes,arrows,trees,fit}
\usetikzlibrary{decorations.pathmorphing} % for snake lines

\tikzstyle{block} = [draw, fill=blue!20, rectangle, minimum height=3em, minimum width=6em]
\tikzstyle{blockx} = [draw, fill=green!20, rectangle, minimum height=3em, minimum width=6em, rounded corners=1mm]
...
% debugging
%\includeonly{lsystems}
%\includeonly{design}
%\includeonly{apx-stdLib}
