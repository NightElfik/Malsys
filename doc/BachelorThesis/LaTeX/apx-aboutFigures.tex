...
All images of \lsystems in this thesis (if not stated otherwise) are created by written \lsystem processing library in web interface.
Source code of figures in the thesis is often simplified because of loack of space but the included source code will produce similar results. 


\figCaption{fig:introLilac} 3D model of lilac
...
\figCaption{fig:introHTree} H-tree fractal
